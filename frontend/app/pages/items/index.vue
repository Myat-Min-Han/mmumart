  ...
  <main class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-5">
    ...
    <div v-else>
        ...
        <div class="flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div>
            ...
            <p class="text-gray-600">
              Find the curated academic resources and student essentials within your campus community
            </p>
          </div>
      ...
      <section class="flex flex-col md:flex-row gap-8">
        ...
        <div class="flex-1">
          <div v-if="!products || products.length === 0" class="text-center text-gray-500">
