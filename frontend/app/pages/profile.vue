<template>
  <div class="min-h-screen bg-gray-50 pb-8">
    ...
    <div v-if="token" class="text-center mt-12 px-6">
      <h2 class="text-lg font-semibold text-primary">{{ user?.name }}</h2>
      <p class="text-xs text-gray-400 mt-1">Member · ID: {{ user?.id }}</p>
    </div>
...
const mainMenuItems = ref([
  ...
  },
  {
    ...
    badge:    null,
    iconPath: 'M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 00-3 3h15.75m-12.75-3h11.218c.51 0 .955-.343 1.087-.835l1.658-6.214A1.125 1.125 0 0016.61 6.75H5.906M7.5 14.25L6.106 5.272M7.5 14.25l-1.5 1.5m12.75-1.5a3 3 0 00-3 3',
    route:    '/cart',
  },
])
